...
#SBATCH --job-name generate_samples_molmo                 # The name of the job that is running
#SBATCH --output /scratch/kapil/slurm-generate-samples-molmo.out  # File to which STDOUT will be written, %j inserts jobid
#SBATCH --error /scratch/kapil/slurm-generate-samples-molmo.err   # File to which STDERR will be written, %j inserts jobid
