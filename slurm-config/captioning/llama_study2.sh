...
#SBATCH --output /scratch/kapil/slurm-llama-study2-full.out    # File to which STDOUT will be written, %j inserts jobid
#SBATCH --error /scratch/kapil/slurm-llama-study2-full.err  	  # File to which STDERR will be written, %j inserts jobid
