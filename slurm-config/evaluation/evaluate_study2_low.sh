...
#SBATCH --output /scratch/kapil/slurm-study2-eval-low.out     # File to which STDOUT will be written, %j inserts jobid
#SBATCH --error /scratch/kapil/slurm-study2-eval-low.err  	  # File to which STDERR will be written, %j inserts jobid
