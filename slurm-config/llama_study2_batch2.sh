...
#SBATCH --job-name llama_study2-batch2                           # The name of the job that is running
#SBATCH --output /scratch/kapil/slurm-llama-study2-batch2.out    # File to which STDOUT will be written, %j inserts jobid
#SBATCH --error /scratch/kapil/slurm-llama-study2-batch2.err  	  # File to which STDERR will be written, %j inserts jobid
...
# run code
python llama_captioner.py --start 2430 --end 4860
