...
#SBATCH --output /scratch/kapil/slurm-llama-study2.out    # File to which STDOUT will be written, %j inserts jobid
#SBATCH --error /scratch/kapil/slurm-llama-study2.err  	  # File to which STDERR will be written, %j inserts jobid
...
# run code
python llama_captioner.py --start 0 --end 5
