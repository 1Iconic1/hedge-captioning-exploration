...
#SBATCH --job-name llama_study2-batch3                           # The name of the job that is running
#SBATCH --output /scratch/kapil/slurm-llama-study2-batch3.out    # File to which STDOUT will be written, %j inserts jobid
#SBATCH --error /scratch/kapil/slurm-llama-study2-batch3.err  	  # File to which STDERR will be written, %j inserts jobid
...
# run code
python llama_captioner.py --start 4860
