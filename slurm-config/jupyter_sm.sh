...
#SBATCH --mem 65536        	                		# Reserve 64 GB RAM for the job
#SBATCH --time 1-00:00    	                		# Max Runtime in D-HH:MM
#SBATCH --partition liv.p    	            			# Partition to submit to
#SBATCH --output /scratch/kapil/slurm-notebook-sm.out   	# File to which STDOUT will be written, %j inserts jobid
#SBATCH --error /scratch/kapil/slurm-notebook-sm.err  		# File to which STDERR will be written, %j inserts jobid
